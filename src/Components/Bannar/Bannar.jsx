...
const Bannar = () => {
    ...
    return (
        <div className=" container mx-auto mt-16 ">
            <div className="rounded-md overflow-hidden bg-[url('https://i.ibb.co/HgG56bZ/question-mark-in-front-of-banner-background-vector.jpg')] h-[500px] bg-no-repeat object-cover bg-center w-full">
