...
const NavBar2 = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full py-2 z-50 ${navbarBackground} ${textColor}`} >
            ...
            user ?
              <>
                ...
                <div onClick={scrollToTop} className=''>
                  <button onClick={handleLogout} className="btn rounded-full hover:text-primary-color hover:bg-white  bg-primary-color text-white font-medium  border-none px-5">LogOut</button>
                </div>
              </>
              :
              <>
