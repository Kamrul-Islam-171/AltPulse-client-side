        ...
        <div>
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-2  h-[600px]'>
                ...
                <div className='text-center flex flex-col justify-center items-center space-y-5'>
                    <Fade direction='down' duration={1000}><h1 className='lg:text-6xl text-4xl font-medium'>Search for an idea</h1></Fade>
                    <Fade direction='up' duration={1000}><p className='text-2xl'>What do you want to try next? Think of something you’re into—like and see what you find.</p>
            ...
            <div className='container mx-auto mt-28 grid lg:grid-cols-3 md:grid-cols-2 gap-8'>
                <Fade duration={2000} cascade damping={0.1} >
            ...
            <div className='container mx-auto mt-20  font-medium'>
                <Fade duration={1000} direction='right'><h1 className='text-3xl'>Alternative Product FAQs: Your Questions Answered</h1></Fade>
                <Fade duration={1000} direction='left'><div className='bg-primary-color h-[2px] mt-3 mb-8 '></div></Fade>
                {/* accordinia */}
                <Fade duration={1000} direction='up'>
