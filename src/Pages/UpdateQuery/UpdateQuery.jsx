    ...
    return (
        <>
         <div className=" h-[850px] relative">
            ...
            <div className="container mx-auto border px-6 py-3 rounded-md mb-8 absolute top-32 md:left-[9%] lg:left-[6%]">
                <Helmet>
                    <title>Update Query</title>
                </Helmet>
                <h1 className="text-5xl text-center font-medium mt-5 text-white">Update Query</h1>
                <div className="">
                    <form noValidate="" className="space-y-3 mt-10 mb-6 " onSubmit={handleSubmit}>
                        <div className="grid lg:grid-cols-2 gap-3 md:grid-cols-2">
                            ...
                            <div className="space-y-1 text-sm">
                                <label htmlFor="ProductBrand" className="block  text-white text-lg">Product Brand</label>
                        ...
                        <div className="space-y-1 text-sm">
                            <label htmlFor="ProductImageURL" className="block text-white text-lg">Product Image</label>
                        ...
                        <div className="grid lg:grid-cols-1 gap-3 md:grid-cols-1 ">
                            <div className="space-y-1 text-sm">
                                <label htmlFor=" QueryTItle" className="block text-white text-lg"> Query TItle</label>
                            ...
                            <div className="space-y-1 text-sm">
                                <label htmlFor="BoycottingReason" className="block text-white text-lg">Boycotting Reason</label>
